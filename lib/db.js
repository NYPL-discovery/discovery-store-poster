...
const auth = ["edwinguzman", ""]//params.auth.split(':')
...
module.exports = { upsertStatement, upsertStatements, createDb, getStatements, getStatement, getStatementsFor, getStatementsWhere, deleteStatements, getStats, initializeData }
