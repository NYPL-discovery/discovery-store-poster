...
const ENTITY_TYPES = ['resource', 'organization', 'location', 'status', 'datasource']
...
module.exports = { upsertStatement, upsertStatements, createDb, getStatements, getStatement, getStatementsFor, deleteStatements, getStats }
