...
const fromMarcJson = (object) => {
  try {
    ...
    const builder = Statement.builder(id, Creator.CORE_SERIALIZER.id, { id: datasource.id, record_id: object.id })
    ...
    if (object.varField('852', ['k'])) hFieldCallNumPrefix = object.varField('852', ['k'])[0]
