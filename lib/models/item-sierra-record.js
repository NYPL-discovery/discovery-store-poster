...
// TODO: We need to bring this in to map itype to locationTypes (pending https://github.com/NYPL/nypl-core-objects/pull/17 )
...
class ItemSierraRecord extends SierraRecord {
  ...
  isResearchItem () {
    ...
    if (itemType) {
      itemTypeImpliesResearch = itemType <= 100 || [132, 133, 134, 135, 142].indexOf(itemType) >= 0

      // TODO: Waiting on https://github.com/NYPL/nypl-core-objects/pull/17
      // This is how this check should be carried out when catalog-item-types mapping gives us locationType:
