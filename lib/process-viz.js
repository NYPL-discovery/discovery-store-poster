  ...
  _monitorVelocities () {
    ...
    var updateVelocities = () => {
      ...
      this.velocity_chart.setData([
        {title: 'Current speed: ' + Math.round(sampleV) + '/s', x: xLabels, y: sampleData, style: { line: 'green' }},
        {title: 'Average speed: ' + Math.round(this.overallV) + '/s', x: xLabels, y: overallData, style: { line: 'red' }}
      ])
    }
